  ...
  return (
    <>
      <div className="bg-slate-100 px-32 pt-10 pb-14">
        ...
        <div
          className="bg-white shadow-destructive mt-10 p-5 w-11/12 mx-auto
      ...
      <div className="px-32 py-16 flex flex-row items-start gap-10">
        <div className="w-3/4">
          <div className="mb-16">
            ...
            <div className="text-muted-foreground">
              <p>
                ...
                Repellendus ut ea eius, error praesentium, dolorum dolorem
                maiores officiis amet debitis perspiciatis nam tempore quis
          ...
          <div className="mb-16">
            <div className="text-4xl font-semibold mb-3">Nice-to-Have</div>
            <div className="text-muted-foreground">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Repellendus ut ea eius, error praesentium, dolorum dolorem
