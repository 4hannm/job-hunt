  ...
  async function getDetailCompany(id: string) {
    ...
    if (data?.Companyoverview[0].image) {
      imageUrl = await supabaseGetPublicUrl(
  ...
  export default async function DetailCompanyPage({ params }: DetailCompanyPageProps) {
